...
const EditCOA = (props) => {
  ...
  const handleSaveCoa = async (event) => {
    ...
    try {
      ...
      console.error(e);
      addToast("Error occured while updating COA!", {
        appearance: "error",
        autoDismiss: true,
      });
    }
  ...
  return (
    <PageWrapper>
      <Row className="text-left">
        <Col xs={6} md={10}>
          <h1 className="text-secondary">COA Details</h1>
        </Col>
        <Col md={2} xs={6}>
          <Link onClick={redirect}>Back to list</Link>
        </Col>
      </Row>
      <Row className="text-left">
        <Col xl={2}>
        ...
        <Col xl={2}>
          <p className="text-secondary">
            {ReactHtmlParser(products[0].productName)}
          </p>
        </Col>
        <Col xl={1}></Col>
        <Col xl={1}></Col>
        ...
        <Col xl={1}>
          <p className="text-secondary">{products[0].region}</p>
        </Col>
        <Col xl={2}></Col>
        <Col xl={2}></Col>
      </Row>
      ...
      <Row className="text-left mt-3">
        <Col xl={2}>
          <p className="text-secondary">Batch Number</p>
        </Col>
        <Col xl={2}>
          <input
            type="text"
      ...
      <Row className="text-left">
        <Col xl={2}>
          <p className="text-secondary">Is External</p>
        </Col>
        <Col xl={2}>
          <CheckBox
            value={isExternal}
            checked={isExternal}
            onClick={handleIsExternal}
            type="checkbox"
          />
        </Col>
        <Col xl={2}></Col>
